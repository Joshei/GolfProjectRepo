	...
	*/
		...
		for (int y = 0; y < 8 ; y++) {
			for (int x = 0; x < 8; x++) {
				...
				mapvertices.push_back(glm::vec3(yplusone, heightMap[xholder][yholder + 1], x));
				mapvertices.push_back(glm::vec3(yplusone, heightMap[xholder + 1][yholder + 1], xplusone));

				mapvertices.push_back(glm::vec3(y, heightMap[xholder][yholder], x));
				mapvertices.push_back(glm::vec3(yplusone, heightMap[xholder + 1][yholder + 1], xplusone));
				mapvertices.push_back(glm::vec3(y, heightMap[xholder + 1][yholder], xplusone));
